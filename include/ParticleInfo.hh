...
inline void Set_LV_5He(G4LorentzVector lv5He)
{
	ParticleInfo_LV_5He=lv5He;
}
inline G4LorentzVector Get_LV_5He()
{
	return ParticleInfo_LV_5He;
}
...
inline void Set_thetaCM(G4float thetaCM)
{
	ParticleInfo_thetaCM=thetaCM;
}
inline G4float Get_thetaCM()
{
	return ParticleInfo_thetaCM;
}
...
G4LorentzVector ParticleInfo_LV_5He;
